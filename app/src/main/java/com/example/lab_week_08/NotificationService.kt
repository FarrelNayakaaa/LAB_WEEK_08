...
class NotificationService : Service() {
    ...
    override fun onCreate() {
        ...
        // Buat HandlerThread agar proses berjalan di thread berbeda
        val handlerThread = HandlerThread("SecondThread").apply { start() }
        serviceHandler = Handler(handlerThread.looper)
    }

    // Fungsi untuk membuat notifikasi dan channel-nya
    ...
    // Jalankan countdown saat service dimulai
    ...
    // Hitung mundur 10 → 0 dan update teks notifikasi tiap detik
    ...
    // Beri tahu MainActivity kalau service sudah selesai
